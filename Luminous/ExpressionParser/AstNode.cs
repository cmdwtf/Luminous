...
namespace Luminous.ExpressionParser
{
	...
	public sealed partial class ParsedExpression
	{
		...
		private sealed class AstNode : IAstTreeNode
		{
			...
			IExpressionElement IAstTreeNode.Value { get => Value; set => Value = value; }

			public readonly List<IAstTreeNode> Children;
			IList<IAstTreeNode> IAstTreeNode.Children => Children/*.AsReadOnly()*/;
			...
			public decimal Evaluate()
			{
				...
				{
					if (_parsedExpression.ZeroOnError)
					{
						return 0m;
					}
