...
namespace Luminous.Traversing
{
	...
	{
		protected object TraverseChild<T>(T child) => TraverseChild(child, null, null);

		protected object TraverseChild<T>(T child, string name) => TraverseChild(child, name, null);
